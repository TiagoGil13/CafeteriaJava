...
public class RelatorioView extends JInternalFrame {
	...
	private RelatorioExportavelEmArquivoTexto exportador;
	...
	protected void onClickExportar() {
		if (destinoSelecionado != null && exportador != null) {
			try {
				exportador.exportar(destinoSelecionado);
				JOptionPane.showMessageDialog(this, 
					"Relatório exportado com sucesso para:\n" + destinoSelecionado.getAbsolutePath(), 
					"Exportação Concluída", 
					JOptionPane.INFORMATION_MESSAGE);
				dispose(); // Fecha a janela após exportar
			} catch (Exception e) {
				e.printStackTrace();
				JOptionPane.showMessageDialog(this, 
					"Falha ao exportar o relatório. Por favor, tente novamente.", 
					"Erro na Exportação", 
					JOptionPane.ERROR_MESSAGE);
			}
		} else {
			JOptionPane.showMessageDialog(this, 
				"Por favor, selecione um destino válido para exportação.", 
