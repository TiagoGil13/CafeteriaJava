...
public class TelaPrincipal extends JFrame implements ActionListener {
	...
	protected JMenuBar createMenuBar() {
		...
		menuItem.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				createAndShowFrameExportarRelatorio(new ClienteService());
			}
		});
		...
		menuItem.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				createAndShowFrameExportarRelatorio(new ProdutoService());
			}
		});
		submenu.add(menuItem);
		// <-- PRODUTOS
		...
		menuItem.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				createAndShowFrameExportarRelatorio(new VendaService());
			}
		});
		submenu.add(menuItem);
			...
			public void actionPerformed(ActionEvent e) {
				VendaService vendaService = new VendaService() {
					...
					public void exportar(File destino) {
						exportarMelhoresClientes(destino);
					}
				};
				createAndShowFrameExportarRelatorio(vendaService);
			}
		});
		submenu.add(menuItem);
		// <-- VENDAS
